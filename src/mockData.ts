...
import { URL } from 'url';
import { FriendshipStatusEnum, UserEventEnum } from './enums';
...
export const chatsMock: ChatMetadataInterface[] = [
    {
        createdAt: '',
        id: 'vvv-aaa',
        users: ['vvv', 'aaa'],
...
export const peoplesModalUserMock: UserInterface.RetrievedType[] = [
    ...
    },
    {
        ...
        name: 'Jed Watson',
        username: 'j_N77',
        friendshipStatus: FriendshipStatusEnum.IS_NOT_FRIEND,
    },
    {
        id: 'ccc',
        name: 'Tim Neutkens',
...
export const postsMock: PostInterface[] = [
    ...
    },
    {
        ...
        mediaList: [
            {
                name: 'aaa',
                url: 'https://picsum.photos/1920/1920?random=10',
                type: 'image/jpeg',
            },
            {
                name: 'aaa',
